...
public class Chip8
{
    ...
    private readonly Key[] keypad = new Key[]
    {
        new Key(ConsoleKey.NumPad1),
        new Key(ConsoleKey.NumPad2),
        new Key(ConsoleKey.NumPad3),
        new Key(ConsoleKey.NumPad4),
        new Key(ConsoleKey.Q),
        new Key(ConsoleKey.W),
        new Key(ConsoleKey.E),
        new Key(ConsoleKey.R),
        new Key(ConsoleKey.A),
        new Key(ConsoleKey.S),
        new Key(ConsoleKey.D),
        new Key(ConsoleKey.F),
        new Key(ConsoleKey.Z),
        new Key(ConsoleKey.X),
        new Key(ConsoleKey.C),
        new Key(ConsoleKey.V),
    };
    ...
    // 8xy4 - ADD Vx, Vy
    // Set Vx = Vx u002B Vy, set VF = carry.
    ...
    // Fx33 - LD B, Vx
    // Store BCD representation of Vx in memory locations I, Iu002B1, and Iu002B2.
    ...
    public void SetKeyPress(ConsoleKey key, bool value)
    {
        for (int i = 0; i < keypad.Length; i++)
        {
            if (keypad[i].ConsoleKey == key)
            {
                keypad[i].IsPressed = value;
            }
        }
    }
    ...
    private struct Key(ConsoleKey consoleKey)
    {
        public readonly ConsoleKey ConsoleKey = consoleKey;
